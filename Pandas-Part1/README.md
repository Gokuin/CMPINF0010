...
2. Type in `git clone https://github.com/pitt-sci-cmpinf0010/Pandas-Part1.git` and hit the enter key
3. This should download a folder to your JupyterHub with the lab (it should be called `Pandas-Part1`)
...
Click here: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/pitt-sci-cmpinf0010/Pandas-Part1/HEAD)
